...
# Define output schema with descriptions
class ReviewAnalysis(TypedDict):
    summary: Annotated[str, "A brief summary of the entire review"]
    pros: Annotated[list[str], "A list of positive features mentioned"]
    cons: Annotated[list[str], "A list of negative features or drawbacks"]
    positive: Annotated[list[str], "Specific positive words or phrases used in the review"]
    negative: Annotated[list[str], "Specific negative words or phrases used in the review"]
    sentiment: Annotated[str, "Overall emotional tone of the review (e.g., positive, negative, neutral, mixed)"]
    key_theme: Annotated[str, "The primary subject or topic of the review"]
